...
<HTML>
	<HEAD>
		<title><%BP.Sys.Language.GetValByUserLang("TanksForYouChose", "感谢您选择"); %> <%=BP.SystemConfig.DeveloperShortName%></title>
				...
				<TR vAlign="top" height="100%">
					<TD vAlign="top" noWrap width="18%"  >
						<TABLE width="100%" cellspacing="1" style="border:1px #abcbe6 solid;">
							<TR>
								<TD border="0" align=center class="GroupTitle" ><b><%=BP.Sys.Language.GetValByUserLang("ShowDoc","显示内容")%> </b></TD>
							</TR>
							<tr>
							...
							<TR>
								...
								<TD> <%=BP.Sys.Language.GetValByUserLang("Height", "高度")%>:</TD>
								  <TD class="TD"><cc1:tb id="TB_H" runat="server" ShowType="Num" Width="80px">400</cc1:tb></TD>
								 </tr>
								<tr style="font-size:12px;">
								<TD><%=BP.Sys.Language.GetValByUserLang("Width","宽度") %>:</TD>
									<TD class="TD" >
  ...
  TabSelectedStyle="background:white;border-bottom:none"
							>
							<iewc:Tab Text=" 表格" DefaultImageUrl="../Images/Pub/Table.gif" ></iewc:Tab>
							<iewc:TabSeparator></iewc:TabSeparator>
							<iewc:Tab Text=" 柱状图" DefaultImageUrl="../Images/Pub/Histogram.ico"></iewc:Tab>
							<iewc:TabSeparator></iewc:TabSeparator>
							<iewc:Tab Text=" 饼图" DefaultImageUrl="../Images/Pub/Pie.ico"></iewc:Tab>
							<iewc:TabSeparator></iewc:TabSeparator>
							<iewc:Tab Text=" 折线图" DefaultImageUrl="../Images/Pub/ZX.ico"></iewc:Tab>
							<iewc:TabSeparator></iewc:TabSeparator>
						</cc1:bptabstrip>
