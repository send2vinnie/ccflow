...
public partial class WF_MapDef_MapFrame : WebPage
{
    #region 属性
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        this.Title = md.Name + " - " + this.ToE("DesignFrame", "设计框架");
        switch (this.DoType)
        {
            case "DtlList":
                BindList(md);
    ...
    public void BindList(MapData md)
    {
        ...
        this.Pub1.AddTable();
        this.Pub1.AddCaptionLeftTX("<a href='MapDef.aspx?MyPK=" + this.MyPK + "'>" + this.ToE("Back", "返回") + ":" + md.Name + "</a> - <a href='MapFrame.aspx?DoType=New&FK_MapData=" + this.FK_MapData + "&sd=sd'><img src='../../Images/Btn/New.gif' border=0/>" + this.ToE("New", "新建") + "</a>");
        this.Pub1.AddTR();
    ...
    public void BindEdit(MapData md, MapFrame dtl)
    {
        ...
        this.Pub1.AddTR();
        this.Pub1.AddTDIdx(idx++);
        this.Pub1.AddTD(this.ToE("URL", "框架连接"));
        tb = new TB();
        tb.ID = "TB_URL";
        tb.Text = dtl.URL;
        tb.Columns = 50;
