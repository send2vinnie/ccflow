...
public partial class WF_UC_ToolWap : BP.Web.UC.UCBase3
{
    ...
    public void Siganture()
    {
       ...
       // this.AddFieldSet(this.ToE("To4", "电子签名设置"));
        ...
        this.Add("<p align=center><img src='../Data/Siganture/" + WebUser.No + ".jpg' border=1 onerror=\"this.src='../Data/Siganture/UnName.jpg'\"/> </p>");
    ...
    public void BindAutoLog()
    {
        ...
        if (dt.Rows.Count == 0)
        {
            if (WebUser.IsWap)
            {
                ...
                this.AddMsgGreen(this.ToE("Note", "提示"), "<hr>" + this.ToE("To6", "没有同事授权给您，您不能使用授权方式登陆。"));

                //this.Add(this.ToE("Note", "提示"));
                //this.Add("<hr>" + this.ToE("To6", "没有同事授权给您，您不能使用授权方式登陆。"));
    ...
    public void BindPer()
    {
        ...
        this.AddB(this.ToE("ESign", "电子签字") + ":<img src='../Data/Siganture/" + WebUser.No + ".jpg' border=1 onerror=\"this.src='../Data/Siganture/UnName.jpg'\"/> ，<a href='Tools.aspx?RefNo=Siganture' >" + this.ToE("Edit", "设置/修改") + "</a>。");
