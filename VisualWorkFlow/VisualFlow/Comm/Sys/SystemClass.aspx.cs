...
namespace BP.Web.Comm.UI
{
	...
	/// SystemClass 的摘要说明。
	/// </summary>
	public partial class SystemClass : WebPage
	{
        ...
        {
            Entity en = DA.ClassFactory.GetEn(enName);
            Map map = en.EnMap;
		...
		//	this.GenerLabel(this.Label1,"系统实体");
            ...
            if (this.IsPostBack == false)
            {
                ...
                this.BPToolBar1.AddBtn(NamesOfBtn.Card, "增加注释");
        ...
        public void Bind()
        {
            ...
            try
            {
                ...
                al = DA.ClassFactory.GetObjects(info);
            }
            catch (Exception ex)
            {
            ...
            foreach (Object obj in al)
            {
                ...
                this.UCSys1.AddTD("<a href=\"javascript:WinOpen('../UIEn.aspx?EnName=" + en.ToString() + "&Type=Check','dtl') ; \" >界面</a>");
