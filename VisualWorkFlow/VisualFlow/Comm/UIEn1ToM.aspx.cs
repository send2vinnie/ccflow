...
namespace BP.Web.Comm.UI
{
    ...
    public partial class UIEn1ToM : WebPage
    {
        ...
        public Entity MainEn
        {
            ...
            {
                if (_MainEn == null)
                    _MainEn = DA.ClassFactory.GetEn(this.Request.QueryString["EnsName"]);
                return _MainEn;
            }
            set
            {
        ...
        protected void Page_Load(object sender, System.EventArgs e)
        {
            ...
            // Entity en1 = DA.ClassFactory.GetEn(this.Request.QueryString["EnsName"]);
        ...
        public void SetDataV2()
        {
            ...
            try
            {
                ...
                if (this.DDL_Group.SelectedValue == "无")
                {
                    if (this.IsLine)
