...
public partial class OA_UC_FtpSet : BP.Web.UC.UCBase3
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        this.AddTDTitle("岗位 <a href=FtpSet.aspx?DoType=1>刷新</a>");
        this.AddTDTitle("ftp链接设置");
        this.AddTREnd();
    ...
    void btn_Click(object sender, EventArgs e)
    {
        ...
        foreach (BP.WF.Port.WFEmp emp in emps)
        {
            try
            {
                string no = this.GetTextBoxByID("TB_" + emp.No).Text;
                emp.FtpUrl = no;
                emp.Update();
            }
            catch
        ...
        this.Response.Redirect("FtpSet.aspx",true);
    }
    public void BindWap()
    {
