    ...
    public class MainForm : BP.Win32.PageBase
	{
		...
		private void InitializeComponent()
		{
          ...
          //  this.M_Edit = new System.Windows.Forms.MenuItem();
            ...
            this.Btn_New.Text = this.ToE("NewFlow","新建流程");
            // 
            // Btn_Save 
            // 
            this.Btn_Save.ImageIndex = 2;
            this.Btn_Save.Name = "Btn_Save";
            this.Btn_Save.Text = this.ToE("Save", "保存");// "保存";
            // 
            // Btn_Open
            // 
            this.Btn_Open.ImageIndex = 1;
            this.Btn_Open.Name = "Btn_Open";
            this.Btn_Open.Text = this.ToE("Open", "打开"); // "打开";
            ...
            this.Btn_SaveAll.Text = this.ToE("SaveAll", "全部保存"); // "全部保存";
          //  this.Btn_SaveAll.ToolTipText = "全部保存";
            ...
            this.Btn_DeptEdit.Text = this.ToE("Dept", "部门维护");// "部门维护";
            // 
            // Btn_StationEdit
            // 
            this.Btn_StationEdit.ImageIndex = 6;
            this.Btn_StationEdit.Name = "Btn_StationEdit";
            this.Btn_StationEdit.Text = this.ToE("Station", "岗位维护"); // "岗位维护";
            ...
            this.Btn_EmpEdit.Text = this.ToE("Emp", "工作人员维护"); // ;// "工作人员维护";
            ...
            this.Btn_OperVideo.Text = this.ToE("Help", "录像帮助");
            ...
            this.Btn_Exit.Text = this.ToE("Exit", "退出");  // "退出";
            ...
            this.pan1.Name = "pan1";
            this.pan1.Size = new System.Drawing.Size(200, 345);
            ...
            this.tree1.Size = new System.Drawing.Size(196, 341);
          ...
          //  this.M_Edit,
            ...
            //this.M_Edit.Index = 4;
            //this.M_Edit.Text = this.ToE("Edit", "编辑");  // "编辑";
            ...
            // 
            this.M_Del.Index = 4;
            this.M_Del.Text = this.ToE("Del", "删除"); // "删除";
            ...
            // 
            this.M_Ref.Index = 6;
            this.M_Ref.Text = this.ToE("Refurbish", "刷新"); // "刷新";
            ...
            // sBar1
            // 
            this.sBar1.Location = new System.Drawing.Point(0, 375);
