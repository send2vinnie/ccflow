...
namespace SMSServices
{
    ...
    public partial class FrmMain : Form
    {
        ...
        private void DoSendMsg()
        {
            int idx = 0;
            #region 发送消息
            BP.Sys.SMSs sms = new BP.Sys.SMSs();
            BP.En.QueryObject qo = new BP.En.QueryObject(sms);
            sms.Retrieve(BP.Sys.SMSAttr.SMSSta, (int)BP.Sys.SMSSta.UnRun);
            foreach (BP.Sys.SMS sm in sms)
            {
                ...
                {
                    sm.HisSMSSta = BP.Sys.SMSSta.RunOK;
                    sm.Update();
                    continue;
                }
                try
...
#warning 尚未实现。
        ...
        public void SendMail(BP.Sys.SMS sms)
        {
            ...
            try
            {
                ...
                sms.HisSMSSta = BP.Sys.SMSSta.RunOK;
                sms.Update();
            }
