...
namespace BP.Sys.Xml
{
	...
	/// </summary>
    public class EnumInfoXml : XmlEnNoName
    {
        #region 属性
        /// <summary>
        /// Vals
        ...
        public string Vals
        {
            get
            {
                return this.GetValStringByKey(EnumInfoXmlAttr.Vals);
            }
        }
        #endregion
	...
	public class EnumInfoXmls:XmlEns
	{
        ...
        public override string File
        {
            get
            {
                return SystemConfig.PathOfXML + "\\EnumInfo.xml";
            }
        }
		/// <summary>
		/// 物理表名
