	...
	public class PubClass 
	{
        ...
        public static string FilesViewStr(string enName, object pk)
        {
            ...
            foreach (SysFileManager file in ens)
            {
                ...
                {
                    strs += "<a title='打开它' href=\"javascript:DoAction('" + path + "Comm/Do.aspx?ActionType=1&OID=" + file.OID + "&EnsName=" + enName + "&PK=" + pk + "','删除文件《" + file.MyFileName + file.MyFileExt + "》')\" ><img src='" + path + "/WF/Img/Btn/delete.gif' border=0 alt='删除此附件' /></a>&nbsp;";
                }
            }
            return strs;
        }
