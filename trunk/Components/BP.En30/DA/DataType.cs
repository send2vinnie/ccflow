...
namespace BP.DA
{
	...
	public class DataType
	{
        ...
        public static float PraseToMB(long val)
        {
            ...
            //    try
            //    {
            //        //  long byteCount = Convert.ToInt64(val);
            //        if (val >= 1073741824)
            //            size = String.Format("{0:##.##}", val / 1073741824) + " GB";
            //        else if (val >= 1048576)
            //            size = String.Format("{0:##.##}", val / 1048576) + " MB";
            //        else if (val >= 1024)
            //            size = String.Format("{0:##.##}", val / 1024) + " KB";
            //        else if (val > 0 && val < 1024)
            //            size = val.ToString() + " Byte";    //Bytes are unimportant ;)  
            //    }
            //    catch
            //    {
        ...
        /// <summary>
        /// 把@符号的strs 转化成sql可执行的方式。
        /// 比如：@zhoupeng@jiaozi  转化成 'zhoupeng','jiaozi' 
        /// </summary>
        /// <param name="strs"></param>
        /// <returns></returns>
        public static string PraseAtToInSql(string strs)
        {
            strs = strs.Replace("@", "','");
            strs = strs + "'";
...
//			}
          ...
          //  exp = exp.Replace("*100%", "*100");
			...
			try
			{
				BP.DA.StringExpressionCalculate sc = new StringExpressionCalculate();
