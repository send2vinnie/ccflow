...
namespace BP.WF
{
    ...
    public class Dev2Interface
    {
        ...
        /// 获取当前操作员可以发起的流程集合
        /// </summary>
        /// <returns>BP.WF.Flows 对象集合</returns>
        ...
        public static void Port_SendMail(string userNo, string msgTitle, string msgDoc)
        {
            ...
            BP.Sys.SMS.AddMsg(DateTime.Now.ToString() + WebUser.No, userNo, msgTitle + msgDoc, msgTitle, msgDoc);
        }
        /// <summary>
        /// 发送SMS
        /// </summary>
        ...
        {
            BP.Sys.SMS.AddMsg(DateTime.Now.ToString() + WebUser.No, sendToEmp, msgTitle + msgDoc, msgTitle, msgDoc);
        }
        #endregion 登陆接口
        ...
        public static string Flow_DoPress(Int64 workID, string msg)
        {
            ...
            if (wls.Count == 1)
            {
                ...
                Sys.SMS.AddMsg(workID + DataType.CurrentDataTime, toEmp, mailTitle + msg, mailTitle, msg);
            ...
            else
            {
                foreach (GenerWorkerList wl in wls)
                {
                    ...
                    Sys.SMS.AddMsg(workID + DataType.CurrentDataTime, wl.FK_Emp, mailTitle + msg, mailTitle, msg);
        ...
        /// <param name="fk_NodeSheetfJumpTo">发起后要跳转到的节点(可以为空)</param>
        /// <param name="nextWorker">发起后要跳转到的节点并指定的工作人员(可以为空)</param>
        /// <returns>执行信息</returns>
        public static string Node_StartWork(string flowNo, Hashtable ht, DataSet workDtls, int fk_NodeSheetfJumpTo, string nextWorker)
        {
            Flow fl = new Flow(flowNo);
            Work wk = fl.NewWork();
            Int64 workID = wk.OID;
            ...
            if (nextWorker != null && fk_NodeSheetfJumpTo != 0)
                return wn.NodeSend(new Node(fk_NodeSheetfJumpTo), nextWorker).ToMsgOfHtml();
            else
        ...
        /// 合流点把工作退回.
        /// </summary>
        /// <param name="fk_NodeSheetfHL">合流点编号</param>
        /// <param name="fid">FID</param>
        /// <param name="workid">子线程ID</param>
        /// <param name="msg">退回原因</param>
        /// <returns></returns>
        public static string Node_FHL_Return(int fk_NodeSheetfHL, Int64 fid, Int64 workid, string msg)
        {
            WorkNode wn = new WorkNode(fid, fk_NodeSheetfHL);
            Work wk = wn.HisWork;
            WorkNode mywn = null;
