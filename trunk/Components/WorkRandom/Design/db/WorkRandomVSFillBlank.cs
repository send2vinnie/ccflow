	...
	public class WorkRandomVSFillBlank :WorkVSBase
	{
		...
		public override Map EnMap
		{
			get
			{
				...
				map.AddDDLEntitiesPK(WorkRandomVSFillBlankAttr.FK_Work,"0001","试卷", new WorkFixDesigns(),true);
				map.AddDDLEntitiesPK(WorkRandomVSFillBlankAttr.FK_FillBlank,null,"填空题",new FillBlanks(),true);
				map.AddTBInt(WorkRandomVSFillBlankAttr.Cent,1,"分",true,true);
