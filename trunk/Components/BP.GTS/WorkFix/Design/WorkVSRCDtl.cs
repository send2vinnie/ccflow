	...
	public class WorkVSRCDtl :Entity
	{
		...
		public override Map EnMap
		{
			get
			{
				...
				map.AddDDLEntitiesPK(WorkVSRCDtlAttr.FK_Work,"0001","试卷",new WorkFixDesigns(),false);
				map.AddDDLEntitiesPK(WorkVSRCDtlAttr.FK_RCDtl,1,DataType.AppInt,"阅读问答题",new RCDtls(), RCDtlAttr.OID, RCDtlAttr.Name,false);
				
				map.AddTBInt(WorkVSRCDtlAttr.Cent,1,"分",true,false);
				map.AddDDLEntities(WorkVSRCDtlAttr.FK_RC,"0001","阅读题",new RCs(),false);
