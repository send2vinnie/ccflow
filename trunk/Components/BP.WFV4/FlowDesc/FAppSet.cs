    ...
    public class FAppSet : EntityOIDName
    {
        ...
        public override Map EnMap
        {
            get
            {
                ...
                map.AddDDLSysEnum(FAppSetAttr.AppType, 0, "类型", true, false, FAppSetAttr.AppType,"@0=外部Url连接@1=本地可执行文件");
                map.AddDDLSysEnum(FAppSetAttr.ShowTime, 0, "发生时间", true, false, FAppSetAttr.ShowTime, "@0=无(显示在表单底部)@1=当工作选择时@2=当保存时@3=当发送时");
