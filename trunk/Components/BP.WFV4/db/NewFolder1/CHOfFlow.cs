...
namespace BP.WF
{
    ...
    public class CHOfFlow : Entity
    {
        ...
        public string FK_Taxpayer
        {
            get
            {
                return this.GetValStringByKey(CHOfFlowAttr.FK_Taxpayer);
            }
            set
            {
                this.SetValByKey(CHOfFlowAttr.FK_Taxpayer, value);
            }
        }
        ...
        public string TaxpayerName
        {
            get
            {
                return this.GetValStringByKey(CHOfFlowAttr.TaxpayerName);
            }
            set
            {
                this.SetValByKey(CHOfFlowAttr.TaxpayerName, value);
            }
        }
        /// <summary>
        /// 部门
        ...
        public override Map EnMap
        {
            get
            {
                ...
                //map.AddTBString(CHOfFlowAttr.FK_Taxpayer, null, "纳税人", true, true, 0, 20, 10);
                //map.AddTBString(CHOfFlowAttr.TaxpayerName, null, "名称", true, true, 0, 400, 10);
