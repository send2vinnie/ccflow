...
namespace BP.WF
{
	...
	public class CHOfNode : Entity
	{
		...
		public float CentOfQU_del
		{
			get
			{
				return this.GetValFloatByKey(CHOfNodeAttr.CentOfQU);
			}
			set
			{
				this.SetValByKey(CHOfNodeAttr.CentOfQU,value);
			}
		}
		...
		public string  FK_Taxpayer
		{
			get
			{
				return this.GetValStringByKey(CHOfNodeAttr.FK_Taxpayer);
			}
			set
			{
				this.SetValByKey(CHOfNodeAttr.FK_Taxpayer,value);
			}
		}
		public string  Emps
		{
		...
		public string  TaxpayerName
		{
			get
			{
				return this.GetValStringByKey(CHOfNodeAttr.TaxpayerName);
			}
			set
			{
				this.SetValByKey(CHOfNodeAttr.TaxpayerName,value);
			}
		}
		...
		public override Map EnMap
		{
            get
            {
               ...
               // Map map = new Map("WF_CHOfNode");
                ...
                map.AddTBString(CHOfNodeAttr.FK_Taxpayer, null, "纳税人", true, true, 0, 20, 10);
                map.AddTBString(CHOfNodeAttr.TaxpayerName, null, "纳税人名称", true, true, 0, 300, 10);
