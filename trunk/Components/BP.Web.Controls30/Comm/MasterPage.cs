...
namespace BP.Web
{
    ...
    public class MasterPage : System.Web.UI.MasterPage
    {
        ...
        private void GenerExcel_pri(System.Data.DataTable dt, string fileName)
        {
            ...
            string fullName = BP.SystemConfig.PathOfTemp + fileName;
            ...
            excel.DefaultFilePath = BP.SystemConfig.PathOfTemp;
            ...
            // string path = Server.MapPath(BP.SystemConfig.PathOfTemp + fileName + ".xls");
        ...
        public static string GenerExcelFile(System.Data.DataTable dt)
        {
            ...
            Excel.Workbook excelWorkbook = excelApp.Workbooks.Open(file, 0,
...
//　　　　　　　Missing.Value,Missing.Value);
      ...
      excelApp=null; 
        ...
        {
            string url = this.Request.ApplicationPath + "/Comm/UIEn.aspx?EnsName=" + enName + "&PK=" + pk;
            if (isOpenWindow)
            {
        ...
        {
            string url = this.Request.ApplicationPath + "/Comm/UIEn.aspx?EnsName=" + className;
            if (isOpenWindow)
            {
