<%@ Control Language="C#" AutoEventWireup="true" CodeFile="VideoMore.ascx.cs" Inherits="GE_Video_VideoMore" %>
                ...
                <tr class="TR">
                    <td class="TD" colspan="2">
                        ...
                        <cc1:GeImage ID="GeImage1" runat="server" GloDBType="DataTable" PageSize="10" ShowPage="True">
                            <GloDBColumns>
                                <cc1:MyListItem ID="MyListItem1" runat="server" DataFormatString="&lt;a target='_blank' href=&quot;VideoDtl.aspx?RefNo=@No&quot;&gt;&lt;img src=&quot;{0}&quot; onerror=&quot;this.src='@DefImgSrc'&quot; height=&quot;@ImgHeight&quot; width='@ImgWidth' style=&quot;border:none&quot; /&gt;&lt;/a&gt;"
