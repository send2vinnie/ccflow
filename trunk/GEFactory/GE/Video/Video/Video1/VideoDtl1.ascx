<%@ Control Language="C#" AutoEventWireup="true" CodeFile="VideoDtl1.ascx.cs" Inherits="GE_Video_VideoDtl1" %>
                ...
                <tr>
                    <td class='TD'>
                        ...
                        <cc1:GeImage ID="GeImage1" runat="server" GloDBType="DataTable" PageSize="10" ShowPage="False">
                            <GloDBColumns>
                                <cc1:MyListItem ID="MyListItem4" runat="server" DataFormatString="&lt;a href=&quot;VideoDtl1.aspx?RefNo=@No&quot;&gt;&lt;img src=&quot;{0}&quot; onerror=&quot;this.src='@DefImgSrc'&quot; height=&quot;@ImgHeight&quot; width='@ImgWidth' style=&quot;border:none&quot; /&gt;&lt;/a&gt;"
                                ...
                                <cc1:MyListItem ID="MyListItem5" runat="server" DataFormatString="&lt;a style=&quot;width:'@ImgWidth';overflow: hidden;white-space: nowrap;-o-text-overflow: ellipsis;text-overflow: ellipsis;&quot; href=&quot;VideoDtl1.aspx?RefNo=@No&quot;&gt;{0}&lt;/a&gt;"
