        ...
        switch (this.DoType)
        {
            case "DownLoad":
                ...
                try
                {
                    ...
                    if (i == 0)
                    {
                        throw new Exception("该文件不存在或已被删除!");
                    }
                    ...
                    HttpCookie hc = System.Web.HttpContext.Current.Request.Cookies[userNo + "Video2" + file.OID.ToString()];
                    if (hc != null)
                    {
                        //下载
                    ...
                    {
                        HttpCookie cookie = new HttpCookie(userNo + "Video2" + file.OID.ToString());
                        ...
                        if (HttpDownload(file.WebPath, file.MyFileName + "." + file.MyFileExt))
                        {
                            ...
                            en.Retrieve(Video2Attr.No, file.RefVal.ToString());
