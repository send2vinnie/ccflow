<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Video1.ascx.cs" Inherits="GE_Video_Video1" %>
    ...
    <tr>
        <td class="TD">
            ...
            <cc1:GeImage ID="GeImage1" runat="server" GloDBType="DataTable" GloRepeatColumns="2"
                ShowPage="False">
                <GloDBColumns>
                    <cc1:MyListItem ID="MyListItem1" runat="server" DataFormatString="&lt;a target='_blank' href=&quot;VideoDtl1.aspx?RefNo=@No&quot;&gt;&lt;img src=&quot;{0}&quot; onerror=&quot;this.src='@DefImgSrc'&quot; height=&quot;@ImgHeight&quot; width='@ImgWidth'  /&gt;&lt;/a&gt;"
