<%@ Page Title="" Language="C#" MasterPageFile="~/WF/OneFlow/MasterPage.master" AutoEventWireup="true" CodeFile="Archive.aspx.cs" Inherits="WF_OneFlow_Archive" %>
...
<%
   ...
   <td class="TD" width="80%"><a href="javascript:WinOpen('<%=appPath %>/WF/WFRpt.aspx?WorkID=<%=workid%>&FK_Flow=<%=fk_flow%>&FID=<%=fid%>')" ><img src='<%=appPath %>/WF/Img/WFState/Save.png' class="Icon"  /><%=title %></a></td>
