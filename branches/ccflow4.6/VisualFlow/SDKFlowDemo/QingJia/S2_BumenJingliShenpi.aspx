<%@ Page Title="" Language="C#" MasterPageFile="~/SDKFlowDemo/QingJia/MasterPage.master" AutoEventWireup="true" CodeFile="S2_BumenJingliShenpi.aspx.cs" Inherits="Demo_QingJia_S2_BumenJingliShenpi" %>
     ...
     <tr>
        <td  align=left>
            ...
            <asp:Button ID="Btn_Send" runat="server" Text="发送" 
                onclick="Btn_Send_Click" Width="40px"   />
