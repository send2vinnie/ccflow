           ...
           // this.Add("<table border=0 cellpadding='0'  style='border-collapse: collapse;width:30%' cellspacing='0'  >");
            ...
            if (en.EnMap.Attrs.Contains("MyFileName"))
            {
                ...
                if (fileExt != "")
                {
                    ...
                    string path1 = filePath.ToLower();
                    path1 = path1.Replace(path, "");
                    url = "&nbsp;&nbsp;<a href='" + cf.FJWebPath + "/" + en.PKVal + "." + fileExt + "' target=_blank ><img src='../Images/FileType/" + fileExt + ".gif' border=0 />" + fileName + "</a>";
                }
                ...
                if (fileExt != "")
                {
                    ...
                    btn1.ImageUrl = "./../../Images/Btn/Delete.gif";
            ...
            foreach (AttrFile attrF in fileAttrs)
            {
                ...
                else
                {
                    ...
                    btn_m.ImageUrl = "./../../Images/Btn/Delete.gif";

                    //btn_m.ImageUrl = "../Images/Btn/Del.gif";
