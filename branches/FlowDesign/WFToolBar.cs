	...
	public class WFToolBar : System.Windows.Forms.ToolBar
	{
        ...
        public void FillToolBarButton(int count)
        {
            ...
            try
            {
                ...
                this.Buttons[1].Text = this.ToE("OrdinaryNode", "普通节点");
                this.Buttons[2].Text = this.ToE("CheckNode", "审核节点");
                this.Buttons[3].Text = this.ToE("NodeLine", "节点连接线");
                this.Buttons[4].Text = this.ToE("Label", "标签");
            }
            catch
            {
            }
