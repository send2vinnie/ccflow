<%@ Page language="c#" Inherits="BP.Web.Comm.ErrPage" CodeFile="ErrorPage.aspx.cs" %>
		...
		<form method="post" runat="server">
			...
			<TR bgColor="#ff9900" height="0" align="center">
				<TD valign="top" height="0"><FONT face="宋体" color="#000066" size="2">Email:
						<%=BP.SystemConfig.ServiceMail%> ,Tel:<%=BP.SystemConfig.ServiceTel%>。
						<BR>
						<a href="javascript:javascript:window.close(1)" > <%=BP.Sys.Language.GetValByUserLang("Close","关闭")%></a>
					</FONT>
				</TD>
			</TR>
			</TBODY>
