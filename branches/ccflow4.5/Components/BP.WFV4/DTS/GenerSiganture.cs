...
namespace BP.WF.DTS
{
    ...
    public class GenerSiganture : Method
    {
        ...
        public GenerSiganture()
        {
            ...
            this.Help = "此功能需要用户对 "+ BP.SystemConfig.PathOfDataUser + "\\Siganture\\ 有读写权限，否则会执行失败。";
        }
        /// <summary>
        /// 设置执行变量
        /// </summary>
        ...
        public override object Do()
        {
            ...
            {
                return "执行失败，请确认对 " + BP.SystemConfig.PathOfDataUser + "\\Siganture\\ 目录有访问权限？异常信息:"+ex.Message;
            }
        }
    }
}
