...
//		}
        ...
        public static void ClearLog()
        {
            try
            {
                File.Delete(BP.SystemConfig.PathOfLog + DateTime.Now.ToString("\\yyyy_MM_dd.log"));
            }
            catch
            {
            }
...
//			string stub = DateTime.Now.ToString("@HH:MM:ss") ;
        ...
        {
            string file = BP.SystemConfig.PathOfLog;
            try
            {
        ...
        {
            string file = BP.SystemConfig.PathOfLog + DateTime.Now.ToString("yyyy_MM_dd") + ".log";
            try
            {
                System.Diagnostics.Process.Start(file);
            }
