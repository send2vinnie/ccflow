...
namespace BP.WF
{
	...
	public class MsgsManager
	{
		...
		public static int GetMsgsCountByEmpID(int empId)
		{
			...
			return msgs.GetMsgsCountByEmpID(empId);
			*/
		}
		/// <summary>
		/// 清除信息
	...
	public class Msgs:ArrayList
	{
		...
		public int GetMsgsCountByEmpID(int empId)
		{
			...
			if (newMsgNum>0)
			{
                ...
                //    System.Web.HttpContext.Current.Response.Write("<bgsound src='"+System.Web.HttpContext.Current.Request.ApplicationPath+Web.WebUser.NoticeSound+"' loop=1 >"  );
                //if (WebUser.IsTextAlert)
                //    BP.PubClass.ResponseWriteBlueMsg("您有["+newMsgNum+"]个新工作." );
				//System.Web.HttpContext.Current.Response.Write("<bgsound src='"+System.Web.HttpContext.Current.Request.ApplicationPath+Web.WebUser.NoticeSound+"' loop=1 >"  );
