...
namespace BP.DTS
{
	...
	abstract public class DataIOEn2
	{
		...
		/// 可以使用此调度的用户。
		/// </summary>
		public UserType HisUserType=UserType.SysAdmin;
		/// <summary>
		/// 获取在 DTS 中的编号。
		/// </summary>
		/// <returns></returns>
...
//						len+=10;
		...
		public DataTable FromDBUrlRunSQLReturnTable(string selectSql)
		{
			...
			switch(this.FromDBUrl)
			{
				...
				case DBUrlType.DBAccessOfMSSQL2000:
					dt=DBAccessOfMSSQL2000.RunSQLReturnTable( selectSql );
					break;
				...
				case DBUrlType.DBAccessOfOracle9i:
					dt=DBAccessOfOracle9i.RunSQLReturnTable( selectSql );
					break;
				case DBUrlType.DBAccessOfOracle9i1:
					dt=DBAccessOfOracle9i1.RunSQLReturnTable( selectSql );
					break;
				default:
					break;
			}
		...
		public int ToDBUrlRunDropTable(string table)
		{
			switch(this.ToDBUrl)
			{
				...
				case DBUrlType.DBAccessOfMSSQL2000:
					return DBAccessOfMSSQL2000.RunSQL(table);
				case DBUrlType.DBAccessOfODBC:
					return DBAccessOfODBC.RunSQL(table);
				case DBUrlType.DBAccessOfOLE:
					return DBAccessOfOLE.RunSQL(table);
				case DBUrlType.DBAccessOfOracle9i:
					return DBAccessOfOracle9i.RunSQLTRUNCATETable(table);
				default:
					throw new Exception("@ error it");
			}
		}
		...
		public bool ToDBUrlIsExit(string sql)
		{
			switch(this.ToDBUrl)
			{
				...
				case DBUrlType.DBAccessOfMSSQL2000:
					return DBAccessOfMSSQL2000.IsExits(sql);
				case DBUrlType.DBAccessOfODBC:
			...
			foreach(DataRow FromDR in FromDataTable.Rows)
			{
				...
				switch(this.ToDBUrl)
				{
					case DA.DBUrlType.AppCenterDSN:
						...
						break;
					case DA.DBUrlType.DBAccessOfMSSQL2000:
						DBAccessOfOLE.RunSQL(InsertSQL);
						break;
					case DA.DBUrlType.DBAccessOfOLE:
						DBAccessOfOLE.RunSQL(InsertSQL);
						break;
					case DA.DBUrlType.DBAccessOfOracle9i:
						DBAccessOfOracle9i.RunSQL(InsertSQL);
						break;
			...
			foreach(DataRow FromDR in FromDataTable.Rows)
			{
				...
				switch(this.ToDBUrl)
				{
					case DA.DBUrlType.AppCenterDSN:
						...
						break;
					case DA.DBUrlType.DBAccessOfMSSQL2000:
						DBAccessOfMSSQL2000.RunSQL(InsertSQL);
						break;
					case DA.DBUrlType.DBAccessOfOLE:
						DBAccessOfOLE.RunSQL(InsertSQL);
						break;
		...
		public void DeleteObjData()
		{
			...
			switch(this.ToDBUrl)
			{
				...
				case DA.DBUrlType.DBAccessOfOLE:
					...
					break;
				case DA.DBUrlType.DBAccessOfOracle9i:
                    DBAccessOfOracle9i.RunSQL("DELETE  FROM " + this.ToTable);
					break;
				case DA.DBUrlType.DBAccessOfODBC:
		...
		public DataTable GetToDataTable()
		{
			...
			switch(this.ToDBUrl)
			{
				...
				case DA.DBUrlType.DBAccessOfOLE:
					...
					break;
				case DA.DBUrlType.DBAccessOfOracle9i:
					FromDataTable=DBAccessOfOracle9i.RunSQLReturnTable(sql);
					break;
				case DA.DBUrlType.DBAccessOfODBC:
		...
		public DataTable GetFromDataTable()
		{
			...
			switch(this.FromDBUrl)
			{
				...
				case DA.DBUrlType.DBAccessOfOLE:
					...
					break;
				case DA.DBUrlType.DBAccessOfOracle9i:
					FromDataTable=DBAccessOfOracle9i.RunSQLReturnTable(FromSQL);
					break;
				case DA.DBUrlType.DBAccessOfODBC:
		...
		public void Inphase()
		{
			...
			switch(this.ToDBUrl)
			{
				...
				case DA.DBUrlType.DBAccessOfOLE:
					...
					break;
				case DA.DBUrlType.DBAccessOfOracle9i:
					ToDataTable=DBAccessOfOracle9i.RunSQLReturnTable(ToSQL);
					break;
				case DA.DBUrlType.DBAccessOfODBC:
			...
			foreach(DataRow FromDR in FromDataTable.Rows)
			{
				...
				switch(this.ToDBUrl)
				{
					...
					case DA.DBUrlType.DBAccessOfOLE:
						...
						break;
					case DA.DBUrlType.DBAccessOfOracle9i:
						result=DBAccessOfOracle9i.RunSQL(UpdateSQL);	
						break;
					case DA.DBUrlType.DBAccessOfODBC:
			...
			foreach(DataRow ToDR in ToDataTable.Rows)
			{
				...
				switch(this.FromDBUrl)
				{
					...
					case DA.DBUrlType.DBAccessOfOLE:
						...
						break;
					case DA.DBUrlType.DBAccessOfOracle9i:
						result=DBAccessOfOracle9i.RunSQL(SELECTSQL);
						break;
					case DA.DBUrlType.DBAccessOfODBC:
				...
				if(result!=1)
				{
					...
					switch(this.ToDBUrl)
					{
						...
						case DA.DBUrlType.DBAccessOfOLE:
							...
							break;
						case DA.DBUrlType.DBAccessOfOracle9i:
							DBAccessOfOracle9i.RunSQL(DeleteSQL);
							break;
						case DA.DBUrlType.DBAccessOfODBC:
			...
			if(this.UPDATEsql!=null)
			{
				switch(this.ToDBUrl)
				{
					...
					case DA.DBUrlType.DBAccessOfOLE:
						...
						break;
					case DA.DBUrlType.DBAccessOfOracle9i:
						DBAccessOfOracle9i.RunSQL(UPDATEsql);
						break;
					case DA.DBUrlType.DBAccessOfODBC:
