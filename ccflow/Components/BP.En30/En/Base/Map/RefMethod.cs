...
namespace BP.En
{
    ...
    public class RefMethod
    {
        ...
        public string GetIcon(string path)
        {
            ...
            {
                return null;
                return "<img src='../Images/Btn/Do.gif'  border=0 />";
            }
            else
            {
        ...
        public object Do(object[] paras)
        {
            ...
            if (this.HisEn == null)
            {
                this.HisEn = DA.ClassFactory.GetEn(clas);
                Attrs attrs = this.HisEn.EnMap.Attrs;

                //if (SystemConfig.IsBSsystem)
                //{
                //    //string val = System.Web.HttpContext.Current.Request.QueryString["No"];
                //    //if (val == null)
                //    //{
                //    //    val = System.Web.HttpContext.Current.Request.QueryString["PK"];
                //    //}
                //    this.HisEn.PKVal = System.Web.HttpContext.Current.Request.QueryString[this.HisEn.PK];
                //}
                //else
