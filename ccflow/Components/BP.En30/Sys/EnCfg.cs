    ...
    public class EnCfg : EntityNo
    {
        ...
        public string FJSavePath
        {
            get
            {
                ...
                if (str == "" || str == null || str==string.Empty)
                    return BP.SystemConfig.PathOfDataUser + this.No + "\\";
                return str;
            }
            set
            {
        ...
        public string FJWebPath
        {
            get
            {
                ...
                if (str == "" || str == null)
                    return System.Web.HttpContext.Current.Request.ApplicationPath +"/DataUser/" + this.No + "/";
                return str;
            }
            set
            {
        ...
        public override Map EnMap
        {
            get
            {
                ...
                map.AddTBString(EnCfgAttr.GroupTitle, null, "分组标签", true, false, 0, 100, 60);
