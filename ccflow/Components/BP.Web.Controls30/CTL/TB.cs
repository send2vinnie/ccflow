            ...
            set
            {
                ...
                switch (_ShowType)
                {
                    case TBType.Ens: //如果是要制定的Ens.
                        ...
                        url = appPath + "/Comm/DataHelp.htm?" + appPath + "/Comm/UIEns.aspx?EnsName=" + this.DataHelpKey + "&IsDataHelp=1";
                    ...
                    case TBType.EnsOfMany: //如果是要制定的Ens.
                        //this.Width=Unit.Pixel(this.DefaultWith);
                        url = appPath + "/Comm/DataHelp.htm?" + appPath + "/Comm/UIDataHelpEnsValues.aspx?EnsName=" + this.DataHelpKey + "&IsDataHelp=1&RefKey=" + this.RefKey + "&RefText=" + this.RefText;
