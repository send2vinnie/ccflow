...
namespace BP.Web
{
    ...
    public  class PageBase : System.Web.UI.Page
	{
        ...
        public Control GenerLabel(string title)
        {
            ...
            str += "<TR>";
            str += "<TD>";
            str += "<IMG src='" + path + "/Images/DG_Title_Left.gif' border='0' width='30' height='25'></TD>";

            str += "<TD  valign=bottom noWrap background='" + path + "/Images/DG_Title_BG.gif'   height='25' border=0>&nbsp;";
            str += " &nbsp;<b>" + title + "</b>&nbsp;&nbsp;";
            str += "</TD>";
            str += "<TD >";
            str += "<IMG src='" + path + "/Images/DG_Title_Right.gif' border='0' width='25' height='25'></TD>";
            str += "</TR>";
            str += "</TABLE>";
		...
		public Control GenerLabel_bak(string title)
		{
           // return this.ParseControl(title);
			...
			str+="</TD>";
			str+="<TD>";
            str += "<IMG src='" + path + "/Images/DG_Title_Right.gif' border='0' width='25' height='20'></TD>";
			str+="</TR>";
			str+="</TBODY>";
			str+="</TABLE>";
			return this.ParseControl( str) ;
		...
		/// </summary>
		/// <param name="en"></param>
		protected void GenerRptByPeng(Entity en)
		{
			RrfReport.GenerRptByPeng(en);
		} 
		...
		/// </summary>
		/// <param name="en"></param>
        protected void GenerRptDoc(Entity en, string file)
        {
            Entities ens = en.GetNewEntities;
            ens.AddEntity(en);
            RrfReport.GenerRpt(ens, file);
        } 

		protected void GenerRptDocWithXml(Entity en, string cyclostyfilename)
		{
			RrfReport.GenerRptWithXml(en,cyclostyfilename);
		}
		protected void GenerRptDoc(Entities ens, string cyclostyfilename)
		{
			RrfReport.GenerRpt(ens,cyclostyfilename);
		}
		...
		public void ExportEntityToExcel(string classbaseName)
		{
            ...
            foreach (Object obj in als)
            {
                try
                {
                    ...
                    {
                        objStreamWriter.WriteLine(Convert.ToChar(9) + "编码结构" + Convert.ToChar(9) + map.CodeStruct + "是否允许编号重复" + Convert.ToChar(9) + map.IsAllowRepeatNo + "是否检查编号的长度" + Convert.ToChar(9) + map.IsCheckNoLength + "是否检查XXX" + Convert.ToChar(9) + map.IsCheckXXX);
                    }
		...
		protected void ResponseWriteShowModalDialogRedMsg(string msg)
		{
			...
			System.Web.HttpContext.Current.Session["info"]=msg;
//			string url=System.Web.HttpContext.Current.Request.ApplicationPath+"/Comm/Port/ErrorPage.aspx";
				string url=System.Web.HttpContext.Current.Request.ApplicationPath+"/Comm/Port/ErrorPage.aspx?d="+DateTime.Now.ToString();
		...
		{	 
			msg=msg.Replace("@","<BR>@");
			System.Web.HttpContext.Current.Session["info"]=msg;
			string url=System.Web.HttpContext.Current.Request.ApplicationPath+"/Comm/Port/InfoPage.aspx?d="+DateTime.Now.ToString();
...
//			ResponseWriteBlueMsg("删除成功!");
        ...
        protected void ToErrorPage(string mess)
        {
            ...
            System.Web.HttpContext.Current.Response.Redirect(System.Web.HttpContext.Current.Request.ApplicationPath + "/Comm/Port/ToErrorPage.aspx?d=" + DateTime.Now.ToString(), false);
        }
		/// <summary>
		/// 切换到信息也面。
		/// </summary>
		...
		{
			System.Web.HttpContext.Current.Session["info"]=mess;
			System.Web.HttpContext.Current.Response.Redirect(System.Web.HttpContext.Current.Request.ApplicationPath+"/Comm/Port/InfoPage.aspx target='_top'");
		}
