...
namespace WF.WS {
    ...
    public interface WSDesignerSoap {
        ...
        [System.ServiceModel.OperationContractAttribute(AsyncPattern=true, Action="http://tempuri.org/GetTrack", ReplyAction="*")]
        [System.ServiceModel.XmlSerializerFormatAttribute(SupportFaults=true)]
        System.IAsyncResult BeginGetTrack(string fk_flow, int workid, System.AsyncCallback callback, object asyncState);
        
        string EndGetTrack(System.IAsyncResult result);
    ...
    public partial class WSDesignerSoapClient : System.ServiceModel.ClientBase<WF.WS.WSDesignerSoap>, WF.WS.WSDesignerSoap {
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        System.IAsyncResult WF.WS.WSDesignerSoap.BeginGetTrack(string fk_flow, int workid, System.AsyncCallback callback, object asyncState) {
            return base.Channel.BeginGetTrack(fk_flow, workid, callback, asyncState);
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        string WF.WS.WSDesignerSoap.EndGetTrack(System.IAsyncResult result) {
        ...
        private System.IAsyncResult OnBeginGetTrack(object[] inValues, System.AsyncCallback callback, object asyncState) {
            ...
            return ((WF.WS.WSDesignerSoap)(this)).BeginGetTrack(fk_flow, workid, callback, asyncState);
        }
        
        private object[] OnEndGetTrack(System.IAsyncResult result) {
            string retVal = ((WF.WS.WSDesignerSoap)(this)).EndGetTrack(result);
            return new object[] {
                    retVal};
        }
        ...
        public void GetTrackAsync(string fk_flow, int workid) {
            this.GetTrackAsync(fk_flow, workid, null);
        }
        
        public void GetTrackAsync(string fk_flow, int workid, object userState) {
            ...
            base.InvokeAsync(this.onBeginGetTrackDelegate, new object[] {
                        fk_flow,
                        workid}, this.onEndGetTrackDelegate, this.onGetTrackCompletedDelegate, userState);
        }
        ...
        private class WSDesignerSoapClientChannel : ChannelBase<WF.WS.WSDesignerSoap>, WF.WS.WSDesignerSoap {
            ...
            public System.IAsyncResult BeginGetTrack(string fk_flow, int workid, System.AsyncCallback callback, object asyncState) {
                object[] _args = new object[2];
                _args[0] = fk_flow;
                _args[1] = workid;
            ...
            public string EndGetTrack(System.IAsyncResult result) {
                object[] _args = new object[0];
                string _result = ((string)(base.EndInvoke("GetTrack", _args, result)));
                return _result;
            }
