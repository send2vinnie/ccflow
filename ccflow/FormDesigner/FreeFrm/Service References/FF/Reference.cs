...
namespace FreeFrm.FF {
    ...
    public interface FreeFrmSoap {
        ...
        [System.ServiceModel.XmlSerializerFormatAttribute(SupportFaults=true)]
        System.IAsyncResult BeginCopyFrm(string fromMapData, string fk_mapdata, System.AsyncCallback callback, object asyncState);
    ...
    public partial class FreeFrmSoapClient : System.ServiceModel.ClientBase<FreeFrm.FF.FreeFrmSoap>, FreeFrm.FF.FreeFrmSoap {
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        System.IAsyncResult FreeFrm.FF.FreeFrmSoap.BeginCopyFrm(string fromMapData, string fk_mapdata, System.AsyncCallback callback, object asyncState) {
            return base.Channel.BeginCopyFrm(fromMapData, fk_mapdata, callback, asyncState);
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        string FreeFrm.FF.FreeFrmSoap.EndCopyFrm(System.IAsyncResult result) {
        ...
        private System.IAsyncResult OnBeginCopyFrm(object[] inValues, System.AsyncCallback callback, object asyncState) {
            ...
            return ((FreeFrm.FF.FreeFrmSoap)(this)).BeginCopyFrm(fromMapData, fk_mapdata, callback, asyncState);
        }
        
        private object[] OnEndCopyFrm(System.IAsyncResult result) {
            string retVal = ((FreeFrm.FF.FreeFrmSoap)(this)).EndCopyFrm(result);
            return new object[] {
                    retVal};
        }
        ...
        public void CopyFrmAsync(string fromMapData, string fk_mapdata) {
            this.CopyFrmAsync(fromMapData, fk_mapdata, null);
        }
        
        public void CopyFrmAsync(string fromMapData, string fk_mapdata, object userState) {
            ...
            base.InvokeAsync(this.onBeginCopyFrmDelegate, new object[] {
                        fromMapData,
                        fk_mapdata}, this.onEndCopyFrmDelegate, this.onCopyFrmCompletedDelegate, userState);
        }
        ...
        private class FreeFrmSoapClientChannel : ChannelBase<FreeFrm.FF.FreeFrmSoap>, FreeFrm.FF.FreeFrmSoap {
            ...
            public System.IAsyncResult BeginCopyFrm(string fromMapData, string fk_mapdata, System.AsyncCallback callback, object asyncState) {
