...
'SavePath="./../../../../Data/Uploadfile/"   '设置上传目录（可以是相对路径）

SavePath="/Edu/DataUser/Uploadfile/"   '设置上传目录（可以是相对路径）

'SavePath= HttpRequest.ApplicationPath +"/Data/Uploadfile/"   '设置上传目录（可以是相对路径）
