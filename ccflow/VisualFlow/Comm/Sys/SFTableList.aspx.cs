...
public partial class Comm_Sys_SFTableList : BP.Web.WebPageAdmin
{
    public void BindIt()
    {
        ...
        this.UCSys1.AddCaptionLeft("<a href=SFTableList.aspx ><img src='./../../Images/Btn/Home.gif' border=0>列表</a> -<a href='SFTableList.aspx?DoType=New' ><img src='./../../Images/Btn/New.gif' border=0/>新建</a>- <img src='./../../Images/Btn/Edit.gif' border />编辑:" + sem.No + " " + sem.Name);
        this.UCSys1.AddTR();
    ...
    {
        this.UCSys1.AddTable("width=500px class=Table");
        this.UCSys1.AddCaptionLeft("<a href=SFTableList.aspx ><img src='./../../Images/Btn/Home.gif' border=0 />列表</a> - <img src='./../../Images/Btn/New.gif' />新建编码表");
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (this.DoType == "Del")
        {
            ...
            if (attrs.Count != 0)
            {
                this.UCSys1.AddFieldSet("<a href='SFTableList.aspx' ><img src='./../../Images/Btn/Home.gif' border=0/>返回列表</a> - 删除确认");
        ...
        this.UCSys1.AddCaption("<img src='./../../Images/Btn/Home.gif' border=0/>列表 - <a href='SFTableList.aspx?DoType=New' ><img border=0 src='./../../Images/Btn/New.gif' >新建</a>");
        this.UCSys1.AddTR();
