...
namespace BP.Web.Comm.UI
{
	...
	/// SystemClass 的摘要说明。
	/// </summary>
	public partial class DBIO : WebPage
	{
		...
		public void CheckConnStr()
		{
			...
			if (str == SystemConfig.DBAccessOfOracle9i)
				throw new Exception("AppCenterDSN 不能与 DBAccessOfOracle9i 一样" );
			if (str == SystemConfig.DBAccessOfOracle9i1)
				throw new Exception("AppCenterDSN 不能与 DBAccessOfOracle9i1 一样" );
			...
			if (str == SystemConfig.DBAccessOfMSSQL2000)
				throw new Exception("AppCenterDSN 不能与 DBAccessOfMSSQL2000 一样" );
		...
		protected void Page_Load(object sender, System.EventArgs e)
		{
			...
			if (this.IsPostBack==false)
			{
				...
				ArrayList als =BP.DA.ClassFactory.GetObjects("BP.En.Entities");	
				int i =0;
