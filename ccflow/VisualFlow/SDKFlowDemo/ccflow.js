...
function Track(appPath, fk_flow, workid) {
    alert(appPath);
    var url = appPath + '/WF/WorkFlow.aspx?FK_Flow=' + fk_flow + '&WorkID=' + workid;
...
function Forward(appPath, fk_flow, workid) {
    alert(appPath);
    var url = appPath + '/WF/Forward.aspx?FK_Flow=' + fk_flow + '&WorkID=' + workid;
    window.open(url, 'sd', 'dialogHeight: 550px; dialogWidth: 650px; dialogTop: 100px; dialogLeft: 150px; center: yes; help: no');
    return false;
}
...
function NewFlow(appPath, fk_flow) {
    alert(appPath);
    var url = appPath + '/WF/MyFlow.aspx?FK_Flow=' + fk_flow ;
    window.open(url, 'sd', 'dialogHeight: 550px; dialogWidth: 650px; dialogTop: 100px; dialogLeft: 150px; center: yes; help: no');
    return false;
}
