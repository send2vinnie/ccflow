...
public partial class WF_MapDef_MapM2M : WebPage
{
    ...
    public void BindList(MapData md)
    {
        ...
        this.Pub1.AddTable();
        this.Pub1.AddCaptionLeftTX("<a href='MapDef.aspx?MyPK=" + this.MyPK + "'>" + this.ToE("Back", "返回") + ":" + md.Name + "</a> - <a href='MapM2M.aspx?DoType=New&FK_MapData=" + this.FK_MapData + "&sd=sd'><img src='../../Images/Btn/New.gif' border=0/>" + this.ToE("New", "新建") + "</a>");
        this.Pub1.AddTR();
