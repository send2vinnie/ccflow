...
public partial class WF_MapDef_MapDefDtlFreeFrm :BP.Web.WebPage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        this.Pub1.AddTable("width=100% height='100%' ");
        ...
        this.Pub1.Add("<iframe ID='F" + dtl.No + "' frameborder=0 style='padding:0px;border:0px;'  leftMargin='0'  topMargin='0' src='" + src + "' width='100%' height='300' scrolling=no  /></iframe>");
        this.Pub1.AddTDEnd();
        this.Pub1.AddTREnd();
