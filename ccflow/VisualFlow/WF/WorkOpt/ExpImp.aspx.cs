...
public partial class WF_Opt_ExpImp : WebPage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        this.Pub2.AddUL();
        this.Pub2.AddLi("<a href='ExpImp.aspx?DoType=Word&WorkID=" + this.WorkID + "&FK_Node=" + this.FK_Node + "' ><img src='./../../Images/FileType/doc.gif' border=0/>导出到Word</a>");
        this.Pub2.AddLi("<a href='ExpImp.aspx?DoType=Excel&WorkID=" + this.WorkID + "&FK_Node=" + this.FK_Node + "' ><img src='./../../Images/FileType/xls.gif' border=0/>导出到Excel</a>");
        this.Pub2.AddLi("<a href='ExpImp.aspx?DoType=PDF&WorkID=" + this.WorkID + "&FK_Node=" + this.FK_Node + "' ><img src='./../../Images/FileType/pdf.gif' border=0/>导出到PDF</a>");
        this.Pub2.AddULEnd();
