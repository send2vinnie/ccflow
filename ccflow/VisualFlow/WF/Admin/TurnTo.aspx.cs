...
public partial class WF_Admin_TurnTo : WebPage
{
    #region 属性
    public DDL DDL_Attr
    {
    ...
    public void BindNode()
    {
        ...
        this.Pub1.AddTR();
        this.Pub1.AddTD(this.ToE("OperS", "操作符"));
        ddl = new DDL();
        ddl.ID = "DDL_Oper";
        switch (attrS.LGType)
        {
        ...
        switch (attrS.LGType)
        {
            case BP.En.FieldTypeS.Enum:
                this.Pub1.AddTR();
                this.Pub1.AddTD(this.ToE("Value", "值"));
                ddl = new DDL();
                ddl.ID = "DDL_Val";
        ...
        if (conds.Count > 0)
        {
            ...
            foreach (TurnTo tt in conds)
            {
                ...
                this.Pub1.AddTDA("TurnTo.aspx?MyPK=" + tt.MyPK + "&FK_Node=" + tt.FK_Node, "<img src='../../Images/Btn/Edit.gif' />");
                this.Pub1.AddTDA("TurnTo.aspx?MyPK=" + tt.MyPK + "&FK_Node=" + tt.FK_Node+"&DoType=Del", "<img src='../../Images/Btn/Delete.gif' />");
