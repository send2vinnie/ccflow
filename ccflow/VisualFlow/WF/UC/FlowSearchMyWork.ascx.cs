...
public partial class WF_UC_FlowSearchMyWork : BP.Web.UC.UCBase3
{
    #region attr
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
     ...
     //  this.Response.Write(qo.SQL);
        ...
        this.Pub1.AddCaptionLeftTX("流程查询:" + fl.Name);
        ...
        foreach (GEEntity en in rpts)
        {
            ...
            this.Pub1.AddTD("<a href=\"./../WF/WFRpt.aspx?WorkID=" + en.GetValIntByKey("OID") + "&FID=" + en.GetValByKey("FID") + "&FK_Flow=" + this.FK_Flow + "\" target=bk >" + this.ToE("WorkRpt", "报告") + "</a>-<a href=\"./../WF/Chart.aspx?WorkID=" + en.GetValIntByKey("OID") + "&FID=" + en.GetValByKey("FID") + "&FK_Flow=" + this.FK_Flow + "\" target=bk >" + this.ToE("Track", "轨迹") + "</a>");
            this.Pub1.AddTREnd();
        }
