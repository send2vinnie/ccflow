...
public partial class WF_UC_CalendarUC : BP.Web.UC.UCBase3
{
    ...
    public void BindMonth(DateTime dt)
    {
        ...
        html += "<TR>";
        html += " <TD align=center colspan=7 class=Sum ><a href='" + this.PageID + ".aspx?FK_NY=" + dt.AddMonths(-1).ToString("yyyy-MM") + "&CalendarType=1'  > <img src='./../Images/Arr/Arrowhead_Previous_S.gif' border=0 /> </a>" + year + "年" + month + "月<a href='" + this.PageID + ".aspx?CalendarType=1&FK_NY=" + dt.AddMonths(+1).ToString("yyyy-MM") + "'  ><img src='./../Images/Arr/Arrowhead_Next_S.gif' border=0 /></a></TD>";
        html += "</TR>";
