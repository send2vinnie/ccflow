...
namespace BP.CCOA
{
    public partial class OA_Email
    {
        ...
        {
            string sql = "UPDATE OA_EMAIL SET ISREAD=1 WHERE ISREAD<>1 AND PRIORITYLEVEL=1 AND ADDRESSEE='{0}'";
        ...
        {
            string sql = "UPDATE OA_EMAIL SET PRIORITYLEVEL='{0}' WHERE NO IN ({1})";
