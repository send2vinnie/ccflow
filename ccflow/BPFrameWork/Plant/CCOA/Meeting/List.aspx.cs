...
namespace Lizard.OA.Web.OA_Meeting
{
    public partial class List : BasePage
    {
        ...
        string[] columns = { 
                   OA_MeetingAttr.Recorder,
                   OA_MeetingAttr.Topic,
                   OA_MeetingAttr.PlanAddress,
                   OA_MeetingAttr.PlanMembers,
                   OA_MeetingAttr.RealAddress,
                   OA_MeetingAttr.RealMembers,
                   OA_MeetingAttr.Summary
                   };
        BP.CCOA.OA_Meeting OA_Meeting = new BP.CCOA.OA_Meeting();
        ...
        private int GetQueryRowsCount()
        {
            ...
            return XQueryTool.GetRowCount(OA_Meeting, columns, searchValue);
        }
        ...
        public void BindData()
        {
            ...
            DataTable OA_MeetingTable = XQueryTool.Query<BP.CCOA.OA_Meeting>(OA_Meeting, columns, searchValue, m_PageIndex, m_PageSize, null);

            gridView.DataSource = OA_MeetingTable;
            gridView.DataBind();
