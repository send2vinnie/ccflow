...
<body>
    ...
    <asp:GridView ID="gridView" runat="server" AllowPaging="True" Width="100%" CellPadding="3"
        ...
        <Columns>
            ...
            <asp:BoundField DataField="SenderNumber" HeaderText="发送号码" SortExpression="SenderNumber"
                ItemStyle-HorizontalAlign="Center" />
            <asp:BoundField DataField="ReciveNumber" HeaderText="接收号码" SortExpression="ReciveNumber"
                ItemStyle-HorizontalAlign="Center" />
            <asp:BoundField DataField="SendContent" HeaderText="发送内容" SortExpression="SendContent"
                ItemStyle-HorizontalAlign="Center" />
            <asp:BoundField DataField="ReciveConent" HeaderText="接收内容" SortExpression="ReciveConent"
                ItemStyle-HorizontalAlign="Center" />
            <asp:BoundField DataField="SendTime" HeaderText="发送时间" SortExpression="SendTime"
                ItemStyle-HorizontalAlign="Center" />
            <asp:BoundField DataField="ReciveTime" HeaderText="接收时间" SortExpression="ReciveTime"
                ItemStyle-HorizontalAlign="Center" />
