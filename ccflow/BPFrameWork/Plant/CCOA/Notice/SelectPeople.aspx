<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SelectPeople.aspx.cs" Inherits="CCOA_Notice_SelectPeople" %>
        ...
        <tr>
            <td align="left">
                <%-- <ul id="tree1" class="mini-tree" style="width: 280px; padding: 5px;" textfield="text"
                    idfield="id" url="LoadPeopleTree.aspx" showcheckbox="true" parentfield="pid">
                </ul>--%>
