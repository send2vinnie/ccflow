<%@ Page Title="用户" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="BP.EIP.Web.Port_Emp.List" %>
...
<!--Title -->
		...
		<asp:BoundField DataField="FK_Dept" HeaderText="部门, 外键:对应物理表:Po" SortExpression="FK_Dept" ItemStyle-HorizontalAlign="Center"  /> 
		...
		<asp:BoundField DataField="KeyPass" HeaderText="KeyPass" SortExpression="KeyPass" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="IsUSBKEY" HeaderText="IsUSBKEY" SortExpression="IsUSBKEY" ItemStyle-HorizontalAlign="Center"  /> 
