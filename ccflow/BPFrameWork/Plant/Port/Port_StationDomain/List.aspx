<%@ Page Title="岗位" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="BP.EIP.Web.Port_StationDomain.List" %>
...
<!--Title -->
		...
		<asp:BoundField DataField="FK_Station" HeaderText="FK_Station" SortExpression="FK_Station" ItemStyle-HorizontalAlign="Center"  /> 
