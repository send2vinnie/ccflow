<%@ Page Title="岗位" Language="C#" AutoEventWireup="true" CodeFile="List.aspx.cs"
    Inherits="BP.EIP.Web.Port_StationDomain.List" %>
...
<body>
    ...
    <asp:GridView ID="gridView" runat="server" AllowPaging="True" Width="100%" CellPadding="3"
        ...
        <Columns>
            ...
            <asp:BoundField DataField="FK_Station" HeaderText="FK_Station" SortExpression="FK_Station"
                ItemStyle-HorizontalAlign="Center" />
            <asp:BoundField DataField="FK_Domain" HeaderText="FK_Domain" SortExpression="FK_Domain"
                ItemStyle-HorizontalAlign="Center" />
