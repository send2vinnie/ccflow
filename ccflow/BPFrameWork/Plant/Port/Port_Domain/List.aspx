<%@ Page Title="部门" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="BP.EIP.Web.Port_Domain.List" %>
...
<!--Title -->
		...
		<asp:BoundField DataField="DomainName" HeaderText="DomainName" SortExpression="DomainName" ItemStyle-HorizontalAlign="Center"  /> 
