...
namespace BP.EIP.Web.Port_FunctionOperate
{
    public partial class List : Page
    {
        ...
        string[] columns = { 
                   Port_FunctionOperateAttr.OperateName,
                   Port_FunctionOperateAttr.OperateDesc,
                   Port_FunctionOperateAttr.Control_Name
                   };
        ...
        private int GetQueryRowsCount()
        {
            ...
            return XQueryTool.GetRowCount<BP.EIP.Port_FunctionOperate>(Port_FunctionOperate, columns, searchValue);
        }
        ...
        public void BindData()
        {
            ...
            string searchValue = Request.QueryString["searchvalue"];
            BP.EIP.Port_FunctionOperate Port_FunctionOperate = new BP.EIP.Port_FunctionOperate();
            DataTable Port_FunctionOperateTable = XQueryTool.Query<BP.EIP.Port_FunctionOperate>(Port_FunctionOperate, columns, searchValue, m_PageIndex, m_PageSize, null);

            gridView.DataSource = Port_FunctionOperateTable;
            gridView.DataBind();
