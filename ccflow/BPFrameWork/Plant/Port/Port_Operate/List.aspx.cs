...
namespace BP.EIP.Web.Port_Operate
{
    public partial class List : Page
    {
        ...
        BP.EIP.Port_Operate Port_Operate = new BP.EIP.Port_Operate();
        string[] columns = { 
                   Port_OperateAttr.OperateName
                   };
        ...
        private int GetQueryRowsCount()
        {
            ...
            return XQueryTool.GetRowCount<BP.EIP.Port_Operate>(Port_Operate, columns, searchValue);
        }
        ...
        public void BindData()
        {
            ...
            string searchValue = Request.QueryString["searchvalue"];
            BP.EIP.Port_Operate Port_Operate = new BP.EIP.Port_Operate();
            DataTable Port_OperateTable = XQueryTool.Query<BP.EIP.Port_Operate>(Port_Operate, columns, searchValue, m_PageIndex, m_PageSize, null);

            gridView.DataSource = Port_OperateTable;
            gridView.DataBind();
