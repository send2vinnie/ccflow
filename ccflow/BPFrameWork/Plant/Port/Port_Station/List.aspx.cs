...
namespace BP.EIP.Web.Port_Station
{
    public partial class List : Page
    {
        ...
        string[] columns = { 
                   Port_StationAttr.Name,
                   Port_StationAttr.Description
                   };
        ...
        private int GetQueryRowsCount()
        {
            ...
            return XQueryTool.GetRowCount<BP.EIP.Port_Station>(Port_Station, columns, searchValue);
        }
        ...
        public void BindData()
        {
            ...
            string searchValue = Request.QueryString["searchvalue"];
            BP.EIP.Port_Station Port_Station = new BP.EIP.Port_Station();
            DataTable Port_StationTable = XQueryTool.Query<BP.EIP.Port_Station>(Port_Station, columns, searchValue, m_PageIndex, m_PageSize, null);

            gridView.DataSource = Port_StationTable;
            gridView.DataBind();
        }
