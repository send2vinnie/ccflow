...
namespace BP.EIP.Web.Port_Dept
{
    public partial class List : Page
    {
        ...
        string[] columns = { 
                   Port_DeptAttr.Name,
                   Port_DeptAttr.FullName
                   };

        BP.EIP.Port_Dept Port_Dept = new BP.EIP.Port_Dept();
        ...
        private int GetQueryRowsCount()
        {
            ...
            return XQueryTool.GetRowCount<BP.EIP.Port_Dept>(Port_Dept, columns, searchValue);
        }
        ...
        public void BindData()
        {
            ...
            string searchValue = Request.QueryString["searchvalue"];
            BP.EIP.Port_Dept Port_Dept = new BP.EIP.Port_Dept();
            DataTable Port_DeptTable = XQueryTool.Query<BP.EIP.Port_Dept>(Port_Dept, columns, searchValue, m_PageIndex, m_PageSize, null);

            gridView.DataSource = Port_DeptTable;
            gridView.DataBind();
        }
