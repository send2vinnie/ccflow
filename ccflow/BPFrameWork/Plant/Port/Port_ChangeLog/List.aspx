<%@ Page Title="Port_ChangeLog" Language="C#" AutoEventWireup="true" CodeFile="List.aspx.cs"
    Inherits="BP.EIP.Web.Port_ChangeLog.List" %>
...
<body>
    ...
    <lizard:XGridView ID="gridView" runat="server"  Width="100%" CellPadding="3"
        ...
        <Columns>
            ...
            <asp:BoundField DataField="ChangeDigest" HeaderText="ChangeDigest" SortExpression="ChangeDigest"
                ItemStyle-HorizontalAlign="Center" />
            <asp:BoundField DataField="ChangeDetail" HeaderText="ChangeDetail" SortExpression="ChangeDetail"
                ItemStyle-HorizontalAlign="Center" />
            <asp:BoundField DataField="ChangeType" HeaderText="ChangeType" SortExpression="ChangeType"
                ItemStyle-HorizontalAlign="Center" />
