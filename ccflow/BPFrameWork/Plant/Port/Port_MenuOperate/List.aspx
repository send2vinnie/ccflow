<%@ Page Title="人员岗位" Language="C#" AutoEventWireup="true" CodeFile="List.aspx.cs"
    Inherits="BP.EIP.Web.Port_MenuOperate.List" %>
...
<body>
    ...
    <lizard:XGridView ID="gridView" runat="server"  Width="100%" CellPadding="3"
        ...
        <Columns>
            ...
            <asp:BoundField DataField="FK_Menu" HeaderText="FK_Menu" SortExpression="FK_Menu"
                ItemStyle-HorizontalAlign="Center" />
            <asp:BoundField DataField="FK_Operate" HeaderText="FK_Operate" SortExpression="FK_Operate"
                ItemStyle-HorizontalAlign="Center" />
