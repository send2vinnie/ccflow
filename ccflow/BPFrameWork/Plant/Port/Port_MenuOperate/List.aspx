<%@ Page Title="人员岗位" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="BP.EIP.Web.Port_MenuOperate.List" %>
...
<!--Title -->
		...
		<asp:BoundField DataField="FK_Menu" HeaderText="FK_Menu" SortExpression="FK_Menu" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="FK_Operate" HeaderText="FK_Operate" SortExpression="FK_Operate" ItemStyle-HorizontalAlign="Center"  /> 
