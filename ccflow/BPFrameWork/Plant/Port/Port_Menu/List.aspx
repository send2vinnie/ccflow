<%@ Page Title="人员岗位" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="BP.EIP.Web.Port_Menu.List" %>
...
<!--Title -->
		...
		<asp:BoundField DataField="FK_Function" HeaderText="FK_Function" SortExpression="FK_Function" ItemStyle-HorizontalAlign="Center"  /> 
