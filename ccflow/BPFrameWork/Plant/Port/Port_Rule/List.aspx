<%@ Page Title="人员岗位" Language="C#" AutoEventWireup="true" CodeFile="List.aspx.cs"
    Inherits="BP.EIP.Web.Port_Rule.List" %>
...
<body>
    ...
    <asp:GridView ID="gridView" runat="server" AllowPaging="True" Width="100%" CellPadding="3"
        ...
        <Columns>
            ...
            <asp:BoundField DataField="Permission" HeaderText="需要控制的权限名称" SortExpression="Permission"
                ItemStyle-HorizontalAlign="Center" />
            <asp:BoundField DataField="RulePolicy" HeaderText="RulePolicy" SortExpression="RulePolicy"
                ItemStyle-HorizontalAlign="Center" />
            <asp:BoundField DataField="RuleGroup" HeaderText="规则的分组" SortExpression="RuleGroup"
                ItemStyle-HorizontalAlign="Center" />
            ...
            <asp:BoundField DataField="RuleType" HeaderText="RuleType" SortExpression="RuleType"
                ItemStyle-HorizontalAlign="Center" />
            <asp:BoundField DataField="FK_Domain" HeaderText="所属管理域" SortExpression="FK_Domain"
                ItemStyle-HorizontalAlign="Center" />
