...
namespace BP.PRJ
{
	...
	public class EmpPrjStationAttr
	{
		...
		/// 项目组
		/// </summary>
		public const  string FK_Statioin="FK_Statioin";
        /// <summary>
        /// FK_Emp
        /// </summary>
    ...
    public class EmpPrjStation : Entity
    {
        ...
        public string FK_StatioinT
        {
            get
            {
                return this.GetValRefTextByKey(EmpPrjStationAttr.FK_Statioin);
            }
        }
        /// <summary>
        ///项目组
        /// </summary>
        public string FK_Statioin
        {
            get
            {
                return this.GetValStringByKey(EmpPrjStationAttr.FK_Statioin);
            }
            set
            {
                SetValByKey(EmpPrjStationAttr.FK_Statioin, value);
            }
        }
        #endregion
        ...
        public override Map EnMap
        {
            get
            {
                ...
                map.AddDDLEntitiesPK(EmpPrjStationAttr.FK_Statioin, null, "岗位", new Stations(), true);
    ...
    public class EmpPrjStations : Entities
    {
        ...
        public EmpPrjStations(string GroupNo)
        {
            ...
            qo.AddWhere(EmpPrjStationAttr.FK_Statioin, GroupNo);
            qo.DoQuery();
        }
        #endregion
