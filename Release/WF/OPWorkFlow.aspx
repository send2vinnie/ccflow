<%@ page language="c#" inherits="BP.Web.WF.StopWorkFlow, App_Web_ezyhhdus" %>
					...
					<TABLE id="Table1" width="80%" style=" HEIGHT: 247px" cellSpacing="1" cellPadding="1" border="1">
						<TR>
							<TD align="center" bgColor="activeborder">
                                ...
                                <STRONG>
									请说明原因,然后执行相应的操作。</STRONG>
							</TD>
						</TR>
						<TR>
							<TD style="HEIGHT: 195px" align="center"><cc1:tb id="TB1" runat="server" Height="188px" TextMode="MultiLine" Width="100%">输入原因．．．</cc1:tb></TD>
						</TR>
						<TR>
							<TD align="center">
