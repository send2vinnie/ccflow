<%@ page language="c#" inherits="BP.Web.WF.WF.Option, App_Web_ezyhhdus" %>
		...
		<form id="Form1" method="post" runat="server">
			<FONT face="宋体">
				<TABLE id="Table1" cellSpacing="1" cellPadding="1" height="100%" width="100%" border="1"
					...
					<TR align="right">
						<TD colspan="2">
							<asp:Button id="Btn_Save" runat="server" Text="  确 定  " onclick="Button1_Click"></asp:Button>&nbsp;&nbsp;
							<asp:Button id="Btn_Cancel" runat="server" Text="  取 消  " onclick="Button2_Click"></asp:Button>&nbsp;&nbsp;</TD>
					</TR>
				</TABLE>
			</FONT>
		</form>
