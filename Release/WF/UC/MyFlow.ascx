<%@ control language="C#" autoeventwireup="true" inherits="WF_UC_MyFlow, App_Web_dwfygdvu" %>
...
<table width='100%' border=0  style="height:600px;width:90%" align=center >
<tr>
...
<tr valign="top">
            <td valign="top" height="100%"  align="left" width='100%'  id=' '>
