<%@ page language="C#" masterpagefile="~/WAP/MasterPage.master" autoeventwireup="true" inherits="WAP_Tool, App_Web_lha3j40n" title="Setting" %>
<%@ Register src="../WF/UC/ToolsWap.ascx" tagname="ToolsWap" tagprefix="uc1" %>
