...
namespace Tax666.WebControls
{
    ...
    public class MessageBox
    {
        ...
        private bool _M_WriteToDB = false;    //暂时不写数据表
        private string _M_ReturnScript;
        private List<NavigationUrl> _M_ButtonList = new List<NavigationUrl>();
        #endregion
        ...
        /// 按钮列表
        /// </summary>
        public List<NavigationUrl> M_ButtonList
        {
            get
            {
