<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ArticleBigTypeEdit.aspx.cs" Inherits="Tax666.AppWeb.Manager.AticleManage.ArticleBigTypeEdit" %>
...
<body>
    <form id="form1" runat="server">
        <div class="main">
            <Tax666WebControls:HeadMenuWebControls ID="HeadMenuWebControls1" runat="server" HeadOPTxt="添加/修改文章大类" HeadTitleTxt="添加/修改文章大类">
            ...
            <Tax666WebControls:TabOptionWebControls ID="TabOptionWebControls1" runat="server">
                <Tax666WebControls:TabOptionItem id="TabOptionItem1" runat="server" Tab_Name="添加/修改文章大类">
                    <table width="100%" border="0" cellspacing="1" cellpadding="3" align="center">
                        ...
                        <tr>
                            <td class="table_tdtxt"><font color="red">*</font> 文章大类名称(长度2-20个字符)</td>
                            <td class="table_tdinput"><input type="text" id="txtbigtypename" class="txtinput" style="width:420px;" onfocus="this.select();" runat="server" maxlength="20" /></td>
                        </tr>
                        <tr>
                            <td class="table_tdtxt">大类描述<br />长度限制在200字符以内</td>
                        ...
                        <tr id="SubmitTr" runat="server"><td colspan="2" align="right" class="table_tdbtn">
                            ...
                            <asp:button id="btnNew" CausesValidation="False" runat="server" CssClass="btnbig" Text="添加新大类" OnClick="btnNew_Click"></asp:button>
                            <asp:Button id="btnCancel" runat="server" CssClass="btnbig" Text="文章大类管理" CausesValidation="False" OnClick="btnCancel_Click"></asp:Button></td>
                        </tr>                    
                    </table>
