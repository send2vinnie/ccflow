...
tracer("fond",posClavierLeft,posClavierTop,'<img src="Load.ashx?type=image&file=multiclavier.gif" width=404 height=152 border="0"><br />',"sign")
...
/*zones reactives*/
tracer("masque",posClavierLeft,posClavierTop,'<img src="Load.ashx?type=image&file=1x1.gif" width=404 height=152 border="0" usemap="#clavier">')
document.write('<map name="clavier">')
for (i=0;i<nbTouches;i++){document.write('<area coords="'+posX[i]+','+posY[i]+','+(posX[i]+25)+','+(posY[i]+25)+'" href=# onClick=\'javascript:ecrire('+i+')\'>')}
for (i=0;i<nbActions;i++){document.write('<area coords="'+actC1[i]+','+actC2[i]+','+actC3[i]+','+actC4[i]+'" href=# onClick=\'javascript:'+effet[i]+'\'>')}
