...
override protected void OnInit(EventArgs args)
{
	...
	{
		string FrameSrc="Gecko_InsertDocument.Aspx?IsFrame=1&"+Request.ServerVariables["QUERY_STRING"];
...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		var OxOb2f6=[]; function PostBackAction(){ <%=Page.ClientScript.GetPostBackEventReference(hiddenAction,"")%> ;}  ;
		</script>
		<title></title>
		<style type="text/css">
		.row { HEIGHT: 22px }
				...
				<tr>
										...
										<table border="0" cellpadding="1" cellspacing="0" id="Table4" class="normal">
											...
											<tr>
												...
												<td>
													...
													<img alt="" id="inp_color_preview" src="../images/colorpicker.gif" />
												</td>
											</tr>
											<tr>
												<td>[[CssClass]]:</td>
					...
					<td valign="top">
						...
						<div style="padding-top:4px;">
							<input class="inputbuttoninsert" type="button" value="[[Insert]]" onclick="do_insert()"	id="Button1" name="Button1" />
							    &nbsp;&nbsp;&nbsp; 
