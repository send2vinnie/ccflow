...
override protected void OnInit(EventArgs args)
{
	...
	{
		string FrameSrc="Gecko_InsertFlash.Aspx?IsFrame=1&"+Request.ServerVariables["QUERY_STRING"];
...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		var OxOcb7e=[]; function PostBackAction(){ <%=Page.ClientScript.GetPostBackEventReference(hiddenAction,"")%> ;}  ;
		</script>
		<style type="text/css">
		.row { HEIGHT: 22px }
									...
									<td>
										<table border="0" cellpadding="1" cellspacing="0" class="normal">
											<tr>
												...
												<td style="width:120"><input type="text" name="Width" id="Width" style="WIDTH : 80px" onchange="do_preview()"
														onpropertychange="do_preview()" onkeypress="return CancelEventIfNotDigit()" value="200" /></td>
											</tr>
											<tr>
												<td>[[Height]]:</td>
											...
											<tr>
												...
												<td><input autocomplete="off" type="text" id="bgColortext" name="bgColortext" size="7" style="WIDTH:57px" />	
													<img id="s_bgColortext" src="../images/colorpicker.gif" onclick="SelectColor();" alt="" />											
												</td>
											</tr>
											<tr>
												<td>[[Quality]]:
								...
								<tr>
									<td>
										<table border="0" cellpadding="1" cellspacing="0" class="normal" width="100%">
											...
											<tr>
												<td valign="middle" style="width:110">[[Horizontal]]:</td>
					...
					<td valign="top">
						...
						<fieldset id="fieldsetUpload">
							...
							<table border="0" cellspacing="2" cellpadding="0" width="98%" class="normal">
								<tr>
									<td valign="top" style="width:54%; FONT-SIZE: 8pt; VERTICAL-ALIGN: middle;">
