...
namespace BP.Web.Comm.Sys
{
	...
	/// TestHost 的摘要说明。
	/// </summary>
	public partial class TestHost : WebPage
	{
		...
		public void BindRunSqlRVal()
		{
			...
			{
				object ss = DA.DBAccess.RunSQLReturnVal(sql);
			}
		}
		...
		public void BindConn()
		{
			...
			for(int i=0; i<=time ; i++)
			{
				DataTable db = DA.DBAccess.RunSQLReturnTable(sql);
			}
