...
namespace BP.Web.CT.Comm.Sys
{
	/// <summary>
	/// SystemClassDtl 的摘要说明。
	/// </summary>
	public partial class SystemClassDtl : WebPage
	{
        ...
        {
            BP.En.Entity en = BP.DA.ClassFactory.GetEn(this.EnsName);
           ...
           // string msg = "";
            ...
            foreach (Attr attr in map.Attrs)
            {
                ...
                if (attr.MyFieldType == FieldType.FK || attr.MyFieldType == FieldType.PKFK)
                {
                    ...
                    sql2 = "SELECT COUNT( distinct " + refen.PK + ") FROM " + table;
            ...
            if (en.PKs.Length == 1)
            {
                ...
                sql2 = "SELECT COUNT(DISTINCT " + en.PK + ") FROM " + map.PhysicsTable;
                COUNT2 = DBAccess.RunSQLReturnValInt(sql2);
                if (COUNT1 != COUNT2)
                {
            ...
            this.UCSys1.AddMsgOfInfo("帮助","什么是数据体检? ");
        }
        ...
        public void BindEns()
        {
            ...
            ArrayList al = DA.ClassFactory.GetObjects("BP.En.Entity");
            int i = 0;
        ...
        public void BindEn(Entity  en)
        {
            ...
            if (this.EnsName == null)
                ...
                this.UCSys1.AddCaptionLeftTX("数据结构：" + map.EnDesc + "," + map.PhysicsTable);
