...
public partial class Comm_Sys_EnsDataIO : WebPage
{
    ...
    public void Bind2()
    {
        ...
        DataTable dt = BP.DBLoad.GetTableByExt(filePath, null);
    ...
    void btn_DataIO_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            if (System.IO.File.Exists(filePath)==false)
                filePath = BP.SystemConfig.PathOfWebApp + "/Temp/" + WebUser.No + "DTS.xlsx";
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {
            case "OutHtml":
                Entities ens2 = BP.DA.ClassFactory.GetEns(this.EnsName);
                ens2.RetrieveAll();
                this.Pub1.Clear();
            ...
            case "OutAll":
                ...
                return;
            case "OutCurrent":
                Entities ens1 = BP.DA.ClassFactory.GetEns(this.EnsName);
    ...
    void btn_Click(object sender, EventArgs e)
    {
        try
        {
            if (File.Exists(BP.SystemConfig.PathOfWebApp + "/Temp/" + WebUser.No + "DTS.xls"))
                File.Delete(BP.SystemConfig.PathOfWebApp + "/Temp/" + WebUser.No + "DTS.xls");


            if (File.Exists(BP.SystemConfig.PathOfWebApp + "/Temp/" + WebUser.No + "DTS.xlsx"))
                File.Delete(BP.SystemConfig.PathOfWebApp + "/Temp/" + WebUser.No + "DTS.xlsx");
            ...
            string filePath = BP.SystemConfig.PathOfWebApp + "/Temp/" + WebUser.No + "DTS" + ext;
