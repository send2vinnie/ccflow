...
namespace BP.Sys
{
	...
	public class SysDocFile : EntityMyPK
	{
        ...
        public static string GetValHtmlV2(string enName, string pkVal)
        {
            try
            {
                return BP.DA.DataType.ReadTextFile(BP.SystemConfig.PathOfFDB + enName + "\\" + pkVal + ".fdb");
            }
            catch
            {
                return null;
        ...
        public static void SetValV2(string enName, string pkVal, string val)
        {
            try
            {
                string dir = BP.SystemConfig.PathOfFDB + enName + "\\";
            ...
            {
                throw ex;
                string filePath = BP.SystemConfig.PathOfFDB + enName;
