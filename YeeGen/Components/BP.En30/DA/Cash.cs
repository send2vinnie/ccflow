	...
	public class Cash
	{
        ...
        public static string GetBillStr(string cfile, bool isCheckCash)
        {
            ...
            if (val == null )
            {
                ...
                {
                    BP.Rpt.RTF.RepBill.RepairBill(SystemConfig.PathOfData + "\\CyclostyleFile\\" + cfile);
                }
                try
                {
        ...
        public static string[] GetBillParas_Gener(string cfile, Attrs attrs)
        {
          //  Attrs attrs = en.EnMap.Attrs;
            ...
            if (haveError)
            {
                StreamWriter wr = new StreamWriter(SystemConfig.PathOfData + "\\CyclostyleFile\\" + cfile,
