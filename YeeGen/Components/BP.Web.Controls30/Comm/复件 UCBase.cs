...
namespace BP.Web.UC
{
    ...
    public class UCBase : System.Web.UI.UserControl
    {
            ...
            foreach (Attr attr in attrs)
            {
                ...
                switch (attr.UIContralType)
                {
                    case UIContralType.TB:
                        ...
                        TextBox tb = this.GetTextBoxByID(ctlid);
                        if (tb != null)
                        {
        ...
        public int BindPageIdx(int recNum, int pageSize, int PageIdx, string url, int pageSpan)
        {
            ...
            {
                myidx = PageIdx - 1;
                this.Add("<a href='" + url + "&PageIdx=1' >首页</a> <a href='" + url + "&PageIdx=" + myidx + "'>上一页</a>");
            }
            ...
            {
                myidx = PageIdx + 1;
                this.Add("&nbsp;<a href='" + url + "&PageIdx=" + myidx + "'>下一页</a>&nbsp;<a href='" + url + "&PageIdx=" + pageNum + "'>尾页</a>&nbsp;&nbsp;第" + PageIdx + "/" + pageNum + "页 共" + recNum + "条.");
            }
            else
            {
                this.Add("&nbsp;<a href='" + url + "&PageIdx=" + pageNum + "'>尾页</a>&nbsp;&nbsp;第" + PageIdx + "/" + pageNum + "页 共" + recNum + "条.");
        ...
        {
            if (attr.IndexOf("=1") > 1)
                this.Add("\n<TD class='TD' nowrap " + attr + " width='35%' >");
            else
        ...
        public void BindEntity3ItemReadonly(Entity en, bool isShowDtl)
        {
            ...
            foreach (AttrDesc ad in ads)
            {
                ...
                this.AddTR();
                this.AddTD("valign=top  align=right class='TD'", attr.Desc + "：");
                switch (attr.MyDataType)
                {
