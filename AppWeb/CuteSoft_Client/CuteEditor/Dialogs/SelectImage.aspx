...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		var OxOc8d7=[]; function PostBackAction(){ <%=Page.ClientScript.GetPostBackEventReference(hiddenAction,"")%> ;}  ;
		</script>
		<style type="text/css">
		.row { HEIGHT: 22px }
				...
				<tr>
					...
					<td style="text-align:center">
						...
						<img src="Load.ashx?type=image&file=zoom_out.gif" onclick="Zoom_Out();" alt="[[ZoomOut]]" class="dialogButton"
							onmouseover="CuteEditor_ColorPicker_ButtonOver(this);" /> 
						<img src="Load.ashx?type=image&file=bestfit.gif" onclick="BestFit();" alt="[[BestFit]]" class="dialogButton"
							onmouseover="CuteEditor_ColorPicker_ButtonOver(this);" /> 
						<img src="Load.ashx?type=image&file=Actualsize.gif" onclick="Actualsize();" alt="[[ActualSize]]" class="dialogButton"
							onmouseover="CuteEditor_ColorPicker_ButtonOver(this);" /> 
						<img src="Load.ashx?type=image&file=resize.gif" id="img_AutoThumbnail" onclick="AutoThumbnail();" alt="[[AutoThumbnail]]" class="dialogButton"
							onmouseover="CuteEditor_ColorPicker_ButtonOver(this);" /> 
							<% if(secset.AllowModify) {%>
							<img  class="dialogButton" onmouseover="CuteEditor_ColorPicker_ButtonOver(this);" src="Load.ashx?type=image&file=imageeditor.gif" id="img_ImageEditor" onclick="ImageEditor();" alt="[[ImageEditor]]" />
							<%
							}
							else
							{
