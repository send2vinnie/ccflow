							...
							<table border="0" cellpadding="2" cellspacing="0" class="normal" width="100%">
								...
								<tr>
									...
									<td style="white-space:nowrap;">
										...
										<img alt="" src="Load.ashx?type=image&file=colorpicker.gif" id="bordercolor_Preview"
											style='vertical-align:inherit;behavior:url(Load.ashx?type=htc&file=ColorPicker.htc)' oncolorchange="bordercolor.value=this.selectedColor; bordercolor.style.backgroundColor=this.selectedColor; bordercolor_Preview.style.backgroundColor=this.selectedColor" />
									</td>
									<td></td>
								</tr>
								<tr>
