...
<fieldset>
	...
	<table border="0" cellspacing="0" cellpadding="2" class="normal">
		...
		<tr>
			<td>[[Color]]</td>
			<td>
				<input autocomplete="off" type="text" id="inp_color" style='behavior:url(Load.ashx?type=htc&file=ColorPicker.htc)'
					oncolorpopup="this.selectedColor=value" oncolorchange="this.value=this.selectedColor;FireUIChanged()" />
			</td>
		</tr>
	</table>
</fieldset>
