...
var OxO7d80=["ondblclick","navtd","shiftKey","style"]; Window_GetElement(window,OxO7d80[0x1],true)[OxO7d80[0x0]]=function (){if(event[OxO7d80[0x2]]){ alert(element[OxO7d80[0x3]].cssText) ;} ;}  ;
</script>
