							...
							<tr>
								<td>[[Bordercolor]]:<br />
									...
									<img alt="" id="bordercolor_Preview" src="Load.ashx?type=image&file=colorpicker.gif"
										style='behavior:url(Load.ashx?type=htc&file=ColorPicker.htc)' oncolorchange="bordercolor.value=this.selectedColor; bordercolor.style.backgroundColor=this.selectedColor" />
								</td>
							</tr>
							<tr>
								<td>[[ForeColor]]:<br />
									...
									<img alt="" id="inp_color_Preview" src="Load.ashx?type=image&file=colorpicker.gif"
										style='behavior:url(Load.ashx?type=htc&file=ColorPicker.htc)' oncolorchange="inp_color.value=this.selectedColor; inp_color.style.backgroundColor=this.selectedColor" />
								</td>
							</tr>
							<tr>
								<td>[[Shade]]:<br />
								    ...
								    <img alt="" id="inp_shade_Preview" src="Load.ashx?type=image&file=colorpicker.gif"
										style='behavior:url(Load.ashx?type=htc&file=ColorPicker.htc)' oncolorchange="inp_shade.value=this.selectedColor; inp_shade.style.backgroundColor=this.selectedColor" />
								</td>
							</tr>
						</table>
					</td>
