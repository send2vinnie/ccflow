...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		var OxO50da=[]; function PostBackAction(){ <%=Page.ClientScript.GetPostBackEventReference(hiddenAction,"")%> ;}  ;
		</script>
		<style type="text/css">
		.row { HEIGHT: 22px }
										...
										<table border="0" cellpadding="1" cellspacing="0" id="Table4" class="normal">
											...
											<tr>
												...
												<td><input type="text" id="inp_color" name="inp_color" size="7" style="WIDTH:57px" />
													<img alt="" src="../Load.ashx?type=image&file=colorpicker.gif" id="inp_color_preview"
														style='behavior:url(Load.ashx?type=htc&file=ColorPicker.htc)' oncolorchange="inp_color.value=this.selectedColor; inp_color.style.backgroundColor=this.selectedColor;inp_color_preview.style.backgroundColor=this.selectedColor" />
												</td>
											</tr>
											<tr>
												<td>[[CssClass]]:</td>
