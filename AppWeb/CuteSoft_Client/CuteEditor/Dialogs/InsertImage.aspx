...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>		
		...
		var OxO9fb6=[]; function PostBackAction(){ <%=Page.ClientScript.GetPostBackEventReference(hiddenAction,"")%> ;}  ;
		</script>
		<style type="text/css">
		.row { HEIGHT: 22px }
				...
				<tr>
					...
					<td>
						...
						<img src="../Load.ashx?type=image&file=zoom_out.gif" onclick="Zoom_Out();" alt="[[ZoomOut]]"
							class="dialogButton" onmouseover="CuteEditor_ColorPicker_ButtonOver(this);" />
						<img src="../Load.ashx?type=image&file=bestfit.gif" onclick="BestFit();" alt="[[BestFit]]"
							class="dialogButton" onmouseover="CuteEditor_ColorPicker_ButtonOver(this);" />
						<img src="../Load.ashx?type=image&file=Actualsize.gif" onclick="Actualsize();" alt="[[ActualSize]]"
							class="dialogButton" onmouseover="CuteEditor_ColorPicker_ButtonOver(this);" />
							...
							<table border="0" cellpadding="2" cellspacing="0" width="100%">
								...
								<tr>
									...
									<td style="text-align:left">
										...
										<img alt="[[Preview]]" src="../Load.ashx?type=image&file=colorpicker.gif" id="bordercolor_Preview"
											style='behavior:url(Load.ashx?type=htc&file=ColorPicker.htc); vertical-align:inherit' oncolorchange="bordercolor.value=this.selectedColor; bordercolor.style.backgroundColor=this.selectedColor;bordercolor_Preview.style.backgroundColor=this.selectedColor" />
									</td>
								</tr>
								<tr>
									<td colspan="2">
